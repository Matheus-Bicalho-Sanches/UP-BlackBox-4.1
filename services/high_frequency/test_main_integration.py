"""
Teste da Integração com Sistema Principal
========================================
Verifica se o sistema principal está detectando e exibindo os padrões TWAP à Mercado.
"""
...
async def test_main_integration():
    ...
    try:
        logger.info("🧪 Teste da Integração com Sistema Principal")
        logger.info("=" * 50)
        ...
        # Chama o método que o sistema principal usa
        ...
        # Testa o método get_active_patterns que o frontend usa
        ...
        if active_patterns:
            ...
            for symbol, agents in active_patterns.items():
                ...
                # Mostra alguns exemplos
                for agent_id, pattern in list(agents.items())[:2]:
