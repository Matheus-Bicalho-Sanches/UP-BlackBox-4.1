...
class TickItem:
	__slots__ = ("symbol", "exchange", "price", "volume", "timestamp", "trade_id")
	def __init__(self, symbol: str, exchange: str, price: float, volume: int, timestamp: float, trade_id: int | None):
		self.symbol = symbol
